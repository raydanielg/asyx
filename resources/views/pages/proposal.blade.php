...
<section class="relative py-20 lg:py-28 overflow-hidden" style="background: linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #0f172a 100%);">
    ...
    <div class="container mx-auto px-6 relative z-10 text-center">
        <div class="inline-flex items-center gap-2 px-4 py-1.5 bg-amber-500/20 border border-amber-500/30 rounded-full text-amber-400 text-sm font-semibold mb-6" data-aos="fade-down">
            <i class="fas fa-file-invoice text-xs"></i> Custom Proposal
        </div>
        <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-6 leading-tight" data-aos="fade-up">Get a Tailored Project Proposal</h1>
        <p class="text-slate-400 text-lg max-w-2xl mx-auto mb-10" data-aos="fade-up" data-aos-delay="100">Receive a detailed scope, timeline, and pricing for your specific technology needs within 48 hours.</p>
...
<section class="py-16 bg-white relative overflow-hidden">
    ...
    <div class="container mx-auto px-6 relative z-10">
        <h2 class="text-2xl md:text-3xl font-extrabold text-slate-900 text-center mb-12">What You Will Receive</h2>
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            @php $items = [
                ['icon' => 'fa-list-check', 'title' => 'Detailed Scope', 'desc' => 'Complete breakdown of deliverables and project phases.'],
                ['icon' => 'fa-calendar-days', 'title' => 'Timeline', 'desc' => 'Realistic milestones with clear delivery dates.'],
                ['icon' => 'fa-tag', 'title' => 'Transparent Pricing', 'desc' => 'Itemized costs with no hidden charges.'],
                ['icon' => 'fa-headset', 'title' => 'Post-Deploy Support', 'desc' => 'Maintenance and training plan included.'],
            ]; @endphp
    ...
    <div class="container mx-auto px-6 relative z-10">
        <div class="max-w-2xl mx-auto">
            <div class="text-center mb-10">
                <h2 class="text-3xl font-extrabold text-slate-900 mb-3">Request Your Proposal</h2>
                <p class="text-slate-500">Share your requirements and we will craft a proposal that fits your goals and budget.</p>
            </div>
            ...
            <div class="bg-emerald-50 border border-emerald-200 rounded-2xl p-8 mb-8 text-center" data-aos="zoom-in">
                ...
                <h3 class="font-bold text-emerald-800 text-xl mb-2">Proposal Request Received!</h3>
                <p class="text-emerald-600">Our solutions team will prepare your custom proposal and send it within 48 hours.</p>
            </div>
            @endif

            <form action="{{ route('proposal.submit') }}" method="POST" class="bg-white rounded-2xl p-8 md:p-10 border border-slate-100 shadow-xl" data-aos="fade-up">
                @csrf
                ...
                <div class="mb-6">
                    <label class="block text-sm font-semibold text-slate-700 mb-2">Project Description</label>
                    <textarea name="message" rows="5" class="w-full px-4 py-3 rounded-lg border border-slate-200 focus:border-amber-500 focus:ring-2 focus:ring-amber-200 outline-none transition bg-slate-50 resize-none" placeholder="Describe your project requirements, goals, timeline, and any specific technologies you prefer..."></textarea>
                </div>
                ...
                <button type="submit" class="w-full bg-gradient-to-r from-amber-500 to-amber-600 text-white py-4 rounded-xl font-bold text-lg hover:from-amber-600 hover:to-amber-700 transition shadow-lg hover:shadow-amber-500/30">
                    <i class="fas fa-file-invoice mr-2"></i>Request My Proposal
                </button>
                <p class="text-center text-slate-400 text-sm mt-4">Your information is confidential and used only for preparing the proposal.</p>
            </form>
        </div>
    </div>
</section>
